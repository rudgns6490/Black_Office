	...
	<div id="draftContainer">
		<div class="container-fluid dfcontainer">
			...
			<div class="col-md-12 " style="background-color: #fff;">
	    		<h2 style="border-bottom: solid 1px blue; color:#3399ff; padding: 18px; 0px;">휴가 취소</h2>
				...
				<c:set var="sysYear"><fmt:formatDate value="${now}" pattern="yyyy-MM-dd" /></c:set>
		 		...
		 		<table class="title2">
		 			<tbody>
		 				...
		 				<tr>
		 					<td class="title2Td1">취소 사유</td>
		 					<td class="title2Td">
		 						&nbsp;<textarea name="" class="cancleReason" rows="5" cols="150"></textarea> 
		 					</td>
		 				</tr>
