	...
	<div id="draftContainer"> 
		...
		<div class="row" align="center">
	    	...
	    	<div class="col-md-12 " style="background-color: #fff;">
	    		<h2 style="border-bottom: solid 1px blue; color:#3399ff; padding: 18px; 0px;">출장복명서</h2>
				...
				<c:set var="sysYear"><fmt:formatDate value="${now}" pattern="yyyy-MM-dd" /></c:set>
		 		<table class="title2">
		 			<tbody>
		 				...
		 				<tr>
		 					<td class="title2Td1">수행 및 동행인원</td>
		 					<td class="title2Td">
		 						&nbsp;<input type="text" name="people" class="people2" style="width: 99%;" />
		 					</td>
		 				</tr>
		 				
		 				<tr>
		 					<td class="title2Td1">출장기간</td>
		 					<td class="title2Td">
		 						&nbsp;&nbsp;<input type="date" name="btperiod" />&nbsp;
		 						<span>~</span>
		 						&nbsp;<input type="date" name="btperiod" />&nbsp;
		 					</td>
		 				</tr>
		 				...
		 				<tr>
		 					<td class="title2Td1">출장업무 수행내용 및 결과보고</td>
		 					<td class="title2Td">
		 						&nbsp;<textarea class="report" rows="5" cols="150"></textarea> 
		 					</td>
		 				</tr>
