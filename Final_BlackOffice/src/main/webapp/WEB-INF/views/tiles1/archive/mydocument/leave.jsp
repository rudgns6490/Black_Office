...
<div class="archiveContainer">
	...
	<div class="archiveheader">
		...
		<h5 class="headercon" style="display: inline-block; margin-top: 2px;">내문서</h5>
	</div>
	<%--	맨 위 부분 끝	--%>
	...
	<div class="documentchoice_box">
		<a href="<%=ctxPath %>/mydocument_archive_normal.action" class="documentchoice">일반 결재 문서</a>
		<a href="<%=ctxPath %>/mydocument_archive_expenses.action" class="documentchoice">지출 결재 문서</a>
		<a href="<%=ctxPath %>/mydocument_archive_leave.action" class="documentchoice documentchoice_active">휴가/휴직 결재 문서</a>
	</div>
	<%--	문서종류 선택 끝	 --%>
