...
<div class="archiveContainer">
	...
	<div class="documentchoice_box">
		<a href="<%=ctxPath %>/incomplete_payment_archive.action" class="documentchoice documentchoice_active">미결재문서</a>
		<a href="<%=ctxPath %>/complete_payment_archive.action" class="documentchoice">결재완료문서</a>
	</div>
	<%--	문서종류 선택 끝	 --%>
