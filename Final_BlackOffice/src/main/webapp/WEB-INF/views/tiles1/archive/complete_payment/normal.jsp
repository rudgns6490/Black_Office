...
<div class="archiveContainer">
	...
	<div class="documentchoice_box">
		<a href="<%=ctxPath %>/complete_archive_normal.action" class="documentchoice documentchoice_active">일반 결재 문서</a>
		<a href="<%=ctxPath %>/complete_archive_expenses.action" class="documentchoice">지출 결재 문서</a>
		<a href="<%=ctxPath %>/complete_archive_leave.action" class="documentchoice">휴가/휴직 결재 문서</a>
	</div>
	<%--	문서종류 선택 끝	 --%>
