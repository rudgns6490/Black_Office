...
<div class="archiveContainer">
	...
	<div class="archiveheader">
		...
		<h5 class="headercon" style="display: inline-block; margin-top: 2px;">미결재 문서</h5>
	</div>
	<%--	맨 위 부분 끝	--%>
	...
	<div class="documentchoice_box">
		<a href="<%=ctxPath %>/incomplete_archive_normal.action" class="documentchoice">일반 결재 문서</a>
		<a href="<%=ctxPath %>/incomplete_archive_expenses.action" class="documentchoice">지출 결재 문서</a>
		<a href="<%=ctxPath %>/incomplete_archive_leave.action" class="documentchoice documentchoice_active">휴가/휴직 결재 문서</a>
	</div>
	<%--	문서종류 선택 끝	 --%>
			...
			<form action="">
				<table style="width: 100%;">
					...
					<tr>
						<th>문서종류</th>
						<td>
							<input type="checkbox" name="leave" id="leave" style="margin-left: 5px;"/>
							<label class="document_choice" for="leave">휴가신청서</label>
							
							<input type="checkbox" name="year" id="year" />
							<label class="document_choice" for="year">연차신청서</label>
							
							<input type="checkbox" name="baby" id="baby" />
							<label class="document_choice" for="baby">출산휴가계</label>
							
							<input type="checkbox" name="cancellation" id="cancellation" />
							<label class="document_choice" for="cancellation">휴가취소</label>
							
							<input type="checkbox" name="earlyLeave" id="earlyLeave" />
							<label class="document_choice" for="earlyLeave">조퇴계</label>
							
							<input type="checkbox" name="sickLeave" id="sickLeave" />
							<label class="document_choice" for="sickLeave">병가계</label>
							
							<input type="checkbox" name="out" id="out" />
							<label class="document_choice" for="out">외출계</label>
							
							<input type="checkbox" name="vacation" id="vacation" />
							<label class="document_choice" for="vacation">휴직결재서</label>
							
							<input type="checkbox" name="babyVacation" id="babyVacation" />
							<label class="document_choice" for="babyVacation">육아휴직결재서</label>
						</td>
					</tr>
